...
class ESMPyRegridder:
    ...
    def _save_weights(self) -> None:
        ...
        update_history(ds_weights, "Weights generated by ESMPyRegridder")
    ...
    def _regrid_dataarray(
        ...
        if update_history_attr:
            update_history(
                out,
                f"Regridded using ESMPyRegridder (method={self.method}, "
    ...
    def _regrid_dataset(self, ds_in: xr.Dataset) -> xr.Dataset:
        ...
        update_history(
            out,
            f"Regridded Dataset using ESMPyRegridder (method={self.method}, "
            f"periodic={self.periodic}, skipna={self.skipna})",
        )
